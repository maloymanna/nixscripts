...
- 📏 [benchmark](/benchmark.sh) - Benchmark and compare various parameters for launching llama.cpp with local model

## Useful commands
- `du -ah / | sort -rh | head -n 10` - shows 10 largest files in `/` root directory
- `find / -type f -size +100M` - shows files larger than 100 MB in `/` root directory
